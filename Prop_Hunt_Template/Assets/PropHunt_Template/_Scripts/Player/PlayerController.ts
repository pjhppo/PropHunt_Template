import { BoxCollider, Camera, GameObject, Input, LODFadeMode, MeshFilter, Physics, Ray, RaycastHit, Time, Touch, TouchPhase, Vector3, WaitUntil } from 'UnityEngine';
...
export default class PlayerController extends ZepetoScriptBehaviour {
    ...
    @SerializeField() private icon: GameObject;
    @SerializeField() private iconCharge: Image;
